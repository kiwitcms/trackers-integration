...
class Trac(IssueTrackerType):
    """
    Support for Trac 1.6 and above. Requires:
      base_url Trac server URL - e.g. https://trac.myserver.local
      api_username Trac Username - needs Trac permissions TICKET_CREATE, TICKET_APPEND and TICKET_VIEW
      api_password Trac Password
    Trac project name must match Kiwi product name.
    """
